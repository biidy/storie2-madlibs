...
function rand(event){
 ...
 let randadjcf2= Math.trunc(Math.random()*(adjectifs.length+1));
 let randadjcf3= Math.trunc(Math.random()*(adjectifs.length+1));
 ...
 oneinput[0].value =adjectifs[randadjcf1];
 oneinput[1].value =nouns[randnoun1];
 oneinput[2].value =nouns[randnoun2];
 oneinput[3].value=adverbs[randadverb1];
 oneinput[4].value=nouns[randnoun3];
 oneinput[5].value=verbs[randverb1];
 oneinput[6].value=adjectifs[randadjcf2];
 oneinput[7].value=adjectifs[randadjcf3];
